...
namespace UnityGameFramework.Runtime
{
    public abstract class UIWidget : UIBase
    {
        ...
        /// <returns></returns>
        public bool Create(UIBase parentUI, GameObject widgetRoot, bool visible = true, params System.Object[] userData)
        {
            return CreateImp(parentUI, widgetRoot, false, visible, userData);
        }
        ...
        public bool CreateByPrefab(UIBase parentUI, GameObject goPrefab, Transform parentTrans, bool visible = true, params System.Object[] userData)
        {
            if (parentTrans == null)
            {
            ...
            GameObject instance = Object.Instantiate(goPrefab, parentTrans);
            if (instance != null)
                instance.name = goPrefab.name;
            return CreateImp(parentUI, instance, true, visible, userData);
        }

        public bool BindByInstance(UIBase parentUI, GameObject instance, bool visible = true, params System.Object[] userData)
        {
            return CreateImp(parentUI, instance, true, visible, userData);
        }

        private bool CreateImp(UIBase parentUI, GameObject widgetRoot, bool bindGo, bool visible = true, params System.Object[] userData)
        {
