...
namespace UnityGameFramework.Runtime
{
    ...
    public class UIBase : IViewBase
    {
        ...
        protected virtual void OnBind()
        {
            ...
            {
                if (userDatas[i] is ViewBindingInitParam bindingParam)
                {
        ...
        public T FindChildComponent<T>() where T : Component
        {
            return DUnityUtil.FindChildComponent<T>(rectTransform);
        }

        public T FindChildComponent<T>(Transform trans) where T : Component
        {
            return DUnityUtil.FindChildComponent<T>(trans);
        }

        public T FindComponent<T>() where T : Component
        {
            return DUnityUtil.FindComponent<T>(rectTransform);
        }
        ...
        #region Bind
        // todo delete
        public IViewModelBase m_viewModel;
        public virtual void Bind(IViewModelBase viewModel)
        {
        ...
        public T CreateWidget<T>(string goPath, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
            var goRootTrans = FindChild(goPath);

            if (goRootTrans != null)
            {
                return CreateWidget<T>(goRootTrans.gameObject, visible, userData);
            }
        ...
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public T CreateWidget<T>(Transform parentTrans, string goPath, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
        ...
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public T CreateWidget<T>(GameObject goRoot, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
            var widget = new T();
            if (widget.Create(this, goRoot, visible, userData))
            {
                return widget;
            }
        ...
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public T CreateWidgetByPath<T>(Transform parentTrans, string assetLocation, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
            GameObject goInst = GameModule.Resource.LoadGameObject(assetLocation, parent: parentTrans);
            return CreateWidget<T>(goInst, visible, userData);
        }
        ...
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public async UniTask<T> CreateWidgetByPathAsync<T>(Transform parentTrans, string assetLocation, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
        ...
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public T CreateWidgetByPrefab<T>(GameObject goPrefab, Transform parentTrans = null, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
            var widget = new T();
            if (!widget.CreateByPrefab(this, goPrefab, parentTrans, visible, userData))
            {
                return null;
            }
        ...
        /// <summary>
        /// 把已存在的UIInstance绑定到 widget。
        /// </summary>
        /// <param name="instance">资源创建副本。</param>
        /// <param name="visible">是否可见。</param>
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public T BindWidgetByInstance<T>(GameObject instance, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
            var widget = new T();
            if (!widget.BindByInstance(this, instance, visible, userData))
            {
                return null;
            }
        ...
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public T CreateWidgetByType<T>(Transform parentTrans, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
            return CreateWidgetByPath<T>(parentTrans, typeof(T).Name, visible, userData);
        }
        ...
        /// <typeparam name="T">UIWidget。</typeparam>
        /// <returns>UIWidget实例。</returns>
        public async UniTask<T> CreateWidgetByTypeAsync<T>(Transform parentTrans, bool visible = true, params System.Object[] userData) where T : UIWidget, new()
        {
            return await CreateWidgetByPathAsync<T>(parentTrans, typeof(T).Name, visible, userData);
        }
