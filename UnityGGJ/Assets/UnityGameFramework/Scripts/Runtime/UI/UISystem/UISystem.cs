...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UISystem : GameFrameworkComponent
    {
        ...
        private void Start() 
        {
            ...
            UICamera = m_UICamera != null ? m_UICamera : GameObject.Find("UIRoot/UICamera").GetComponent<Camera>();
            
            UICanvasTransform = m_InstanceRoot != null ? m_InstanceRoot : GameObject.Find("UIRoot/UICanvas").transform;
            ...
            if (m_dontDestroyUIRoot)
            {
                DontDestroyOnLoad(UICanvasTransform.parent != null ? UICanvasTransform.parent : UICanvasTransform);
            }
        ...
        /// <param name="userDatas">用户自定义数据。</param>
        /// <returns>打开窗口操作句柄。</returns>
        public UIWindow ShowUI<T>(params System.Object[] userDatas) where T : UIWindow
        {
            return ShowUIImp(typeof(T), false, userDatas);
        }
        ...
        {
            return ShowUIImp(type, false, userDatas);
        }

        private UIWindow ShowUIImp(Type type, bool isAsync, params System.Object[] userDatas)
        {
        ...
        private UIWindow CreateInstance(Type type)
        {
            ...
            if (attribute != null)
            {
                ...
                window.Init(type.FullName, attribute.WindowLayer, attribute.FullScreen, assetName, attribute.FromResources, attribute.HideTimeToClose, attribute.ResetTransformOnLoad);
            }
            else
            {
                window.Init(type.FullName, (int)UILayer.UI, fullScreen: window.FullScreen, assetName: type.Name, fromResources: false, hideTimeToClose: 10, resetTransformOnLoad: true);
            }
