...
namespace UGFExtensions.Await
{
    public static partial class AwaitableExtensions
    {
        ...
        public static void SubscribeEvent()
        {
            ...
            eventComponent.Subscribe(UnloadSceneSuccessEventArgs.EventId, UnloadSceneSuccess);
            eventComponent.Subscribe(UnloadSceneFailureEventArgs.EventId, UnloadSceneFailure);
        ...
        /// 加载场景（可等待）
        /// </summary>
        public static Task<bool> LoadSceneAsync(this SceneComponent sceneComponent, string sceneAssetName, LoadSceneMode sceneMode = LoadSceneMode.Additive)
        {
#if UNITY_EDITOR
            TipsSubscribeEvent();
#endif
            ...
            sceneComponent.LoadScene(sceneAssetName, sceneMode: sceneMode);
            return tcs.Task;
        }
        ...
        /// 卸载场景（可等待）
        /// </summary>
        public static Task<bool> UnloadSceneAsync(this SceneComponent sceneComponent, string sceneAssetName)
        {
            var tcs = new TaskCompletionSource<bool>();
            s_SceneTcs.Add(sceneAssetName, tcs);
        ...
        private static void UnloadSceneSuccess(object sender, GameEventArgs e)
        {
        ...
        private static void UnloadSceneFailure(object sender, GameEventArgs e)
        {
            ...
            {
                s_SceneTcs.Remove(ne.SceneAssetName);
                tcs.SetException(new GameFrameworkException($"Unload scene failure, scene asset name '{ne.SceneAssetName}'."));
            }
        }
