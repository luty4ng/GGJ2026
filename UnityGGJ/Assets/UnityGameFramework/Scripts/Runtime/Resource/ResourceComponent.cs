...
namespace UnityGameFramework.Runtime
{
    ...
    public class ResourceComponent : GameFrameworkComponent
    {
        ...
        public GameObject LoadGameObject(string location, Transform parent = null, string packageName = "")
        {
            ...
            GameObject go = m_ResourceManager.LoadGameObject(location, parent, packageName);
        ...
        public async UniTask<UnityEngine.Object> LoadAssetAsync(string location, Type type, CancellationToken cancellationToken = default,
            string packageName = "")
        {
            if (string.IsNullOrEmpty(location))
            {
            ...
            return await m_ResourceManager.LoadAssetAsync(location, type, cancellationToken, packageName);
        }
