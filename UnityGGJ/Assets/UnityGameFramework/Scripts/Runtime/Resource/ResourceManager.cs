...
namespace GameFramework.Resource
{
    ...
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        public async UniTask<UnityEngine.Object> LoadAssetAsync(string location, Type type, CancellationToken cancellationToken = default, string packageName = "")
        {
            if (string.IsNullOrEmpty(location))
            {
                throw new GameFrameworkException("Asset name is invalid.");
            ...
            AssetHandle handle = GetHandleAsync(location, type, packageName: packageName);
